...
<head>
    ...
    <title>ADTMS - Archived Clients</title>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white border-b border-gray-200 px-8 py-3 flex items-center justify-between">
                <div class="flex items-center space-x-4 h-[55px] w-auto">
                    <h1 class="text-2xl font-semibold text-gray-800">Archived Clients</h1>
                </div>
            </header>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-orange-700">
                                These clients have been archived. You can restore them to active status or permanently delete them.
                            </p>
                        </div>
                    </div>
                </div>

                <!-- Archived Clients Table Card -->
                <div class="bg-white rounded-lg shadow">
                    <!-- Table Header -->
                    <div class="p-6 border-b border-gray-200">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                            <h3 class="text-lg font-semibold text-gray-800">Archived Clients List</h3>
                            <a href="{{ route('clients.index') }}" class="flex items-center justify-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors whitespace-nowrap">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-6 py-12 text-center">
                                            ...
                                            <h3 class="text-lg font-semibold text-gray-700 mb-2">No Archived Clients</h3>
                                            <p class="text-gray-500">There are no archived clients at the moment.</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="showRestoreModal"
                ...
                <div class="bg-white px-6 pt-6 pb-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4 flex-1">
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">Restore Client</h3>
                            <p class="text-sm text-gray-600 mb-4">
                                Are you sure you want to restore <span class="font-semibold text-gray-900" x-text="restoreClient.fname + ' ' + restoreClient.lname"></span>? This will move them back to the active clients list.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 px-6 py-4 flex flex-col-reverse sm:flex-row justify-end space-y-2 space-y-reverse sm:space-y-0 sm:space-x-3 border-t border-gray-200">
                    ...
                    <form :action="'/clients/' + restoreClient.id + '/restore'" method="POST">
                        @csrf
                        <button type="submit"
                                class="w-full sm:w-auto px-5 py-2.5 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 shadow-lg hover:shadow-xl transition-all">
            ...
            <div x-show="showDeleteModal"
                ...
                <div class="bg-white px-6 pt-6 pb-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4 flex-1">
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">Permanently Delete Client</h3>
                            <p class="text-sm text-gray-600 mb-4">
                                Are you sure you want to <span class="font-bold text-red-600">permanently delete</span> <span class="font-semibold text-gray-900" x-text="deleteClient.fname + ' ' + deleteClient.lname"></span>? This action cannot be undone and all data will be lost forever.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 px-6 py-4 flex flex-col-reverse sm:flex-row justify-end space-y-2 space-y-reverse sm:space-y-0 sm:space-x-3 border-t border-gray-200">
                    ...
                    <form :action="'/clients/' + deleteClient.id" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
