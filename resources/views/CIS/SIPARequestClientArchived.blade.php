...
<head>
    ...
    <title>ADTMS - Archived SIPA Requests</title>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white border-b border-gray-200 px-8 py-3 flex items-center justify-between">
                <div class="flex items-center space-x-4 h-[55px] w-auto">
                    <a href="{{ route('sipa.client.requests', $client->client_id) }}" class="text-gray-500 hover:text-gray-700">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                        </svg>
                    </a>
                    <h1 class="text-2xl font-semibold text-gray-800">
                        Archived SIPA Requests - {{ $client->fname }} {{ $client->lname }}
                    </h1>
                </div>
            </header>

            <!-- Archived SIPA Requests Content -->
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($archivedSipaRequests as $request)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                                            <div class="flex space-x-2">
                                                <!-- Restore Button -->
                                                <button 
                                                    @click="selectedSipa = { id: {{ $request->sipa_id }}, refNo: '{{ $request->sipa_ref_no }}' }; showRestoreModal = true"
                                                ...
                                                <button 
                                                    @click="selectedSipa = { id: {{ $request->sipa_id }}, refNo: '{{ $request->sipa_ref_no }}' }; showDeleteModal = true"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-12 text-center">
                                            ...
                                            <p class="mt-4 text-gray-500 text-sm">No archived SIPA requests found.</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="showRestoreModal"
                ...
                <div class="bg-white px-6 pt-6 pb-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4 flex-1">
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">Restore SIPA Request</h3>
                            <p class="text-sm text-gray-600 mb-4">
                                Are you sure you want to restore <span class="font-semibold text-gray-900" x-text="selectedSipa.refNo"></span>? This will move it back to the active requests.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 px-6 py-4 flex flex-col-reverse sm:flex-row justify-end space-y-2 space-y-reverse sm:space-y-0 sm:space-x-3 border-t border-gray-200">
                    ...
                    <form :action="'/sipa-requests/' + selectedSipa.id + '/restore'" method="POST">
                        @csrf
                        <button type="submit"
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="showDeleteModal"
                ...
                <div class="bg-white px-6 pt-6 pb-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4 flex-1">
                            ...
                            <p class="text-sm text-gray-600 mb-4">
                                Are you sure you want to permanently delete <span class="font-semibold text-gray-900" x-text="selectedSipa.refNo"></span>? <span class="text-red-600 font-semibold">This action cannot be undone!</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 px-6 py-4 flex flex-col-reverse sm:flex-row justify-end space-y-2 space-y-reverse sm:space-y-0 sm:space-x-3 border-t border-gray-200">
                    ...
                    <form :action="'/sipa-requests/' + selectedSipa.id" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
