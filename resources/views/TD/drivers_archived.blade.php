...
<head>
    ...
    <title>ADTMS - Archived Drivers</title>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($archivedDrivers as $driver)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                                            <div class="flex space-x-2">
                                                <!-- Restore Button -->
                                                <button 
                                                    @click="selectedDriver = { id: {{ $driver->driver_id }}, name: '{{ $driver->fname }} {{ $driver->lname }}' }; showRestoreModal = true"
                                                ...
                                                <button 
                                                    @click="selectedDriver = { id: {{ $driver->driver_id }}, name: '{{ $driver->fname }} {{ $driver->lname }}' }; showDeleteModal = true"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-6 py-12 text-center">
                                            ...
                                            <p class="mt-4 text-gray-500 text-sm">No archived drivers found.</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="showRestoreModal"
                ...
                <div class="bg-white px-6 pt-6 pb-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4 flex-1">
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">Restore Driver</h3>
                            <p class="text-sm text-gray-600 mb-4">
                                Are you sure you want to restore <span class="font-semibold text-gray-900" x-text="selectedDriver.name"></span>? This will move them back to the active drivers list.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 px-6 py-4 flex flex-col-reverse sm:flex-row justify-end space-y-2 space-y-reverse sm:space-y-0 sm:space-x-3 border-t border-gray-200">
                    ...
                    <form :action="'/drivers/' + selectedDriver.id + '/restore'" method="POST">
                        @csrf
                        <button type="submit"
        ...
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="showDeleteModal"
                ...
                <div class="bg-white px-6 pt-6 pb-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4 flex-1">
                            ...
                            <p class="text-sm text-gray-600 mb-4">
                                Are you sure you want to permanently delete <span class="font-semibold text-gray-900" x-text="selectedDriver.name"></span>? <span class="text-red-600 font-semibold">This action cannot be undone!</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 px-6 py-4 flex flex-col-reverse sm:flex-row justify-end space-y-2 space-y-reverse sm:space-y-0 sm:space-x-3 border-t border-gray-200">
                    ...
                    <form :action="'/drivers/' + selectedDriver.id" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
